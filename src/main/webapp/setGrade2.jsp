...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
		...
		<div >
		<form action="setGradewithNa" id="setGradewithNa-form" method="post" name="form1">
			<div id="grade2">
					<%
		...
		%>
				...
				<%				
					  ...
					  List<Student> Students= dao.getStudentMessage3(CCCname ,TTname);	
					  List<Integer> a= dao.getGrade1(CCCname ,TTname);
